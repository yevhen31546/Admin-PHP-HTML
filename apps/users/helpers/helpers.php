...
function paginationLinks($current_page, $total_pages, $base_url) {
	...
	if ($current_page == 1) {
		...
		$html .= '<li class="disabled"><a>Første</a></li>';
	} else {
		$html .= '<li><a href="' . $base_url . $http_query . '&page=1">Første</a></li>';
	}
	...
	if ($current_page == $total_pages) {
		$html .= '<li class="disabled"><a>Sidste</a></li>';
	} else {

		$html .= '<li><a href="' . $base_url . $http_query . '&page=' . $total_pages . '">Sidste</a></li>';
	}
