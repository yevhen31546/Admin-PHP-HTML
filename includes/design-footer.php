<footer class="main-footer">
    <div class="pull-right d-none d-sm-inline-block">
        <ul class="nav nav-primary nav-dotted nav-dot-separated justify-content-center justify-content-md-end">
		  ...
		  <li class="nav-item">
			<a class="nav-link" href="#">Udskriv</a>
		  </li>
		</ul>
    </div>
     <div class="pull-left d-none d-sm-inline-block">
        <ul class="nav nav-primary nav-dotted nav-dot-separated justify-content-center justify-content-md-end">
		  <li class="nav-item">
			<a class="nav-link" href="#"><strong><?php echo SITE_NAME;?></strong></a>
		  </li>
		  <li class="nav-item">
			<a class="nav-link" href="http://<?php echo SITE_URL;?>" target="_blank"><?php echo SITE_URL;?></a>
		  </li>
		</ul>
    </div>
	   <center><?php echo Danefy_time(date("Y-m-d H:i:s")); ?></center>
  </footer>
